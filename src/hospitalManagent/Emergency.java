...
//    }
    void show() throws IOException, SQLException {
        ...
        while (y) {
            ...
            System.out.println("\u001B[36m" + "          1.New Emergency Patient Entry\n" +
                    "          2.All Emergency Patient Details\n" +
                    "          3.Search Patient\n" +
...
//                            System.out.println("Connected to MySQL database!");
                    ...
                    String query = "INSERT INTO emergency (fname, lname, age, gen, city, did, date) VALUES (?, ?, ?, ?, ?, ?, ?)";
                    try {
...
//                    }
                    ...
                    break;
                case 2:
                    System.out.println("\u001B[32m" + "Here IS Your All Emergency Patient In The Data :-" + "\u001B[0m");
                    System.out.println("+------------+------------+------------+------------+------------+------------+------------+------------+");
                    ...
                    rs = stmt.executeQuery("SELECT * FROM emergency");
                    while (rs.next()) {
//                int id = rs.getInt("id");
//                String name = rs.getString("name");
                        System.out.printf("\u001B[35m" + "| %-10s | %-10s | %-10s | %-10s | %-10s | %-10s | %-10s | %-10s |%n", rs.getInt("eid"), rs.getString("fname"), rs.getString("lname"), rs.getInt("age"), rs.getString("gen"), rs.getString("city"), rs.getString("did"), rs.getString("Date"));
...
//                    conn1.close();
                ...
                case 3:
                    ...
                    rs = stmt.executeQuery("SELECT * FROM emergency WHERE LOWER(fname) = '" + s1 + "'");
                    if (!rs.next()) {
...
//                    conn12.close();
                    ...
                    break;
                case 4:
                    System.out.println("\u001B[34m" + "Select EmergencyID You Want To Update:- " + "\u001B[0m");
                    System.out.println("+------------+------------+------------+------------+------------+------------+------------+------------+");
                    System.out.printf("\u001B[35m" + "| %-10s | %-10s | %-10s | %-10s | %-10s | %-10s | %-10s | %-10s |%n", "EmergencyID", "FirstName", "LastName", "Age", "Gender", "City", "DoctorID", "Date");
...
//                            System.out.println("Connected to MySQL database!");
                        ...
                        do {
                            ...
                            stmt = conn.createStatement();
                            rs = stmt.executeQuery("SELECT * FROM emergency WHERE eid = " + id);
                    ...
                    switch (ch1){
                        case 1:
                            ...
                            updateRow("emergency","fname",rfname,id1,"eid");
                        ...
                        case 2:
                            ...
                            System.out.println(id1);
                            updateRow("emergency","lname",lfname,id1,"eid");
                            break;
                        case 3:
                            System.out.print("Enter The Age You Want To Replace : ");
                            int  rage = ageset(0,140,"Patient");
                            System.out.println(id1);
                            updateRow1("emergency","age",rage,id1,"eid");
                            break;
                        case 4:
                            System.out.print("Enter Gender You Want To Replace : ");
                            String rgen = genset();
                            System.out.println(id1);
                            updateRow("emergency","gen",rgen,id1,"eid");
                            break;
                        case 5:
                            System.out.print("Enter The City You Want To Replace : ");
                            String rcity = nameset();
                            System.out.println(id1);
                            updateRow("emergency","city",rcity,id1,"eid");
                            break;
                        case 6:
...
//                            System.out.println("Connected to MySQL database!");
                            ...
                            updateRow1("emergency","did",did,id1,"eid");
                ...
                case 5:
                    System.out.println("\u001B[32m" + "Here IS Your All Patient In The Data :-" + "\u001B[0m");
                    System.out.println("+------------+------------+------------+------------+------------+------------+------------+------------+");
                    System.out.printf("\u001B[35m" + "| %-10s | %-10s | %-10s | %-10s | %-10s | %-10s | %-10s | %-10s |%n", "EmerID", "FirstName", "LastName", "Age", "Gender", "City", "DoctorID", "Date");
